...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Most number of months suitable for transmission of{\it P. falciparum} \newline          by{\it An. stephensi} in 2100 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure3AVillenaAnstephensiFalciparum.pdf', '-pdf', '-r300' ,'-Opengl')
...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Fewest number of months suitable for transmission of{\it P. falciparum} \newline          by{\it An. stephensi} in 2100 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure3BVillenaAnstephensiFalciparum.pdf', '-pdf', '-r300' ,'-Opengl')
