...
data=readtable('../../../Figures/FigureS8/aegypti.csv');
...
cbr.Position = pos;
cbr.FontSize=(5/2)*8;
cbr.Label.String='Number of months suitable for transmission of{\it P. falciparum} by{\it An. stephensi} in 2020';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 50 50], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('FigureS8VillenaAnstephensiFalciparum.pdf', '-pdf', '-r300' ,'-Opengl')
