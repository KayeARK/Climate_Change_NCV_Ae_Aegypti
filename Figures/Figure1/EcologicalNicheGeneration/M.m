...
function MosPop=M(T,R,a,gamma,invg,p)

MParams=TempFit(T,a,gamma,invg,p);
decay=1;
%note that we don't include code to generate Figures S11 and S12. These can
%be generated by setting decay to either 1/2 (for FigS11A and S12A) or 2
%(for FigS11B and S12B)
q0=(2./(MParams.invgT.*MParams.aT)).*((1./MParams.pT)+((48/(73*decay)).*(R./MParams.gammaT)));
flush=1-q0;
MosPop=flush.*(73/96).*MParams.invgT.*MParams.gammaT;
