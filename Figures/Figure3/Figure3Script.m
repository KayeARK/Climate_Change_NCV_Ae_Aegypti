...
AvgSimM=load('../../Data/SuitabilityDataAvg202020602100/MAvgClimateProjection.mat').MMedianMat;
AvgSimM(AvgSimM>0)=1;
...
BestCase2020M=load('../../Data/SuitabilityDataStatistics202020602100/BestCase2100').BestCase2020;
WorstCase2020M=load('../../Data/SuitabilityDataStatistics202020602100/WorstCase2100').WorstCase2020;
AvgSim2020M=sum(AvgSimM(:,:,1:12),3);

BestCase2050M=load('../../Data/SuitabilityDataStatistics202020602100/BestCase2100').BestCase2050;
WorstCase2050M=load('../../Data/SuitabilityDataStatistics202020602100/WorstCase2100').WorstCase2050;
