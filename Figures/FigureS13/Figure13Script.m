...
BestCase2100M=load('SuitabilityDataStatistics2100/BestCase2100').BestCase2100;
WorstCase2100M=load('SuitabilityDataStatistics2100/WorstCase2100').WorstCase2100;
...
export_fig('Figure13A.pdf', '-pdf', '-r300' ,'-Opengl')
...
set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure13B.pdf', '-pdf', '-r300' ,'-Opengl')
