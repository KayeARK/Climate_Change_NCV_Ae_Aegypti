...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Most number of months suitable for{\it Ae. albopictus} in 2100 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure3AMordecaiAealbopictus.pdf', '-pdf', '-r300' ,'-Opengl')
...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Fewest number of months suitable for{\it Ae. albopictus} in 2100 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure3BMordecaiAealbopictus.pdf', '-pdf', '-r300' ,'-Opengl')
