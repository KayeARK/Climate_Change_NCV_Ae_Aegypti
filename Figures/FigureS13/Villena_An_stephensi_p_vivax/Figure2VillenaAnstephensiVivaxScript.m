...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Change in transmission suitability of{\it P. vivax} by{\it An. stephensi} in different locations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure2VillenaAnstephensiVivax.pdf', '-pdf', '-r300' ,'-Opengl')
