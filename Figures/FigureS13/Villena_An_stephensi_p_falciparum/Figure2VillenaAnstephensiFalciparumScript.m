...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Change in transmission suitability of{\it P. falciparum} by{\it An. stephensi} in different locations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('Figure2VillenaAnstephensiFalciparum.pdf', '-pdf', '-r300' ,'-Opengl')
