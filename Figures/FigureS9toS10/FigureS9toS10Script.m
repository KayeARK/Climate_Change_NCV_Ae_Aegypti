...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Most number of months suitable for{\it Ae. aegypti} in 2060 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('FigureS9A.pdf', '-pdf', '-r300' ,'-Opengl')
...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Fewest number of months suitable for{\it Ae. aegypti} in 2060 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('FigureS9B.pdf', '-pdf', '-r300' ,'-Opengl')
...
set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('FigureS10A.pdf', '-pdf', '-r300' ,'-Opengl')
...
cbr.Position = pos;
cbr.FontSize=10;
cbr.Label.String='Standard deviation in 2100 over all climate simulations';

set(gcf, 'Units', 'centimeters', 'Position', [0 0 20 20], 'PaperUnits', 'centimeters', 'PaperSize', [15 20]);
export_fig('FigureS10B.pdf', '-pdf', '-r300' ,'-Opengl')
